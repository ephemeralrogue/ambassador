...
Object.defineProperties(authenticator,
{
  ...
  buildAuthenticator:
  {
    value: function buildAuthenticator()
    {
  ...
  */
  ...
  _emissary:
  {
    value: function emissaryAdd(name)
  ...
  */
  ...
  authenticate:
  {
    value: function authenticate(strategy, options, callback)
  ...
  /* authorize ***
    ...
    `strategy` name, with optional `options`. If authorization is
    successful, the result provided by the strategy's verify callback will
  ...
  */
  ...
  deserializeUser:
  {
    value: function deserializeUser(fn, req, done)
    {
  ...
  */
  ...
  serializeUser:
  {
    value: function serializeUser(fn, req, done)
    {
      if (typeof fn === 'function')
  ...
  */
  ...
  /* transformAuthInfo ***
    ...
    along with the authenticated `user` in a strategy's `success()` action. 
    ...
    If no transforms are registered, `info` supplied by the strategy will be
    left unmodified.
  ...
  */
  ...
  transformAuthInfo:
  {
    value: function transformAuthInfo(fn, req, done)
    {
      if (typeof fn === 'function')
  ...
  /* use ***
    ...
    This sets up the given strategy as a nested object within the ambassador
    object under `_strategies`, allowing the strategy to be processed in
