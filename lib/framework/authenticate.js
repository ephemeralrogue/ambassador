...
let authenticateError = Object.create(authenticationError);
...
function connectAuth(ambassador, name, options, callback)
{
  ...
  return function authenticate(req, res, next)
  {
    ...
    (function attempt(i)
    {
      ...
      if (typeof layer.authenticate == 'function')
      {
        ...
        prototype = ambassador._emissary(layer);
      ...
      Object.defineProperties(prototype,
      {
        ...
        */
        ...
        /* fail ***
          ...
          defaulting to 401. Strategies should call this function to fail
        ...
        */
        ...
        /* redirect ***
          ...
          Strategies should call this function to redirect the user (via
        ...
        */
        ...
        /* success ***
          ...
          Authenticate `user`, with optional `info`. Strategies should call
          ...
          for third-party authentication strategies to pass profile details.
