 ...
 * Examples:
 *
 *     ambassador.authenticate('local', { successRedirect: '/', failureRedirect: '/login' });
 *
  ...
  return function authenticate(req, res, next) {
    ...
    (function attempt(i) {
      ...
      if (typeof layer.authenticate == 'function') {
        ...
        prototype = ambassador._strategy(layer);
      ...
      Object.defineProperties(prototype, {
        ...
        redirect: {
          value: function redirect(url, status) {
            // NOTE:
            // Do not use `res.redirect` from Express, because it can't decide
            // what it wants.
            //
